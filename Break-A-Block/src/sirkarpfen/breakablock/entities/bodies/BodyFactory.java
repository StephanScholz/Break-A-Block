package sirkarpfen.breakablock.entities.bodies;
...
public class BodyFactory {
	...
	private static World world = BlockGame.getWorld();
	 ...
	 * 
	 * @see sirkarpfen.breakablock.entities.bodies.FixtureType
	 */
	...
	public static Body createBody(Vector2 location, BodyType bodyType) {
		...
		bodyDef.type = bodyType;
		bodyDef.position.set(location);
		if(world.isLocked()) { System.out.println("world.isLocked()"); }
	 ...
	 * @param shape The Shape used for this fixture.
